package ma.ouss.kafkaspringcloudstream.controllers;
...
public class PageEventController {
    ...
    public PageEvent publish(String name, String topic){
        PageEvent event = new PageEvent(name,Math.random()>0.5 ? "U1":"U2",new Date(),new Random().nextInt(1000));
        ...
        return Flux.interval(Duration.ofSeconds(1))
                .map(seq->{
                    ...
                    while (fetchAll.hasNext()){
                        ...
                        stringLongMap.put(String.valueOf(next.key.key()),next.value);
                    }
